...
-(void)videoView:(RTCEAGLVideoView*)videoView didOutputVideoFrame:(RTCVideoFrame*)videoFrame;
@end
/**
...
@property(nonatomic, weak) id<RTCEAGLVideoViewDelegate> videoDelegate;
...
///  lym  修改 支持暂停
/// 是否继续显示，
/// - Parameter hiddenDisplay: yes的时候不再渲染下一帧
- (void)enableRenderWithHiddenDisplay:(BOOL)hiddenDisplay;

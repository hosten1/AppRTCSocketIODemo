...
- (BOOL)isSameH264ProfileWithParameters:(NSDictionary<NSString *, NSString *> *)aParameters
                            bParameters:(NSDictionary<NSString *, NSString *> *)bParameters;
- (NSDictionary<NSString *, NSString *> *)
    GenerateProfileLevelIdForAnswerWithParameters:
        (NSDictionary<NSString *, NSString *> *)aParameters
                                      bParameters:
                                          (NSDictionary<NSString *, NSString *> *)bParameters;
@end
...
// 添加日志传入路径参数  skx 2019-08-09
@property(nonatomic, copy) NSString *logFilePath;

/// 用来区分是单个peer还是多个peer，
/// 功能:不影响之前单人的音频录制逻辑
//@property(nonatomic, assign) BOOL isMutlClass;
// 截屏视频轨道的编码最低比特率。这意味着将填充比特增加到该比特率，这在从静态场景切换到动态场景时会有所帮助
// absl::optional<int> screencast_min_bitrate;
@property(nonatomic, assign) int screencast_min_bitrate;
/*lym 新增代码 end */
- (instancetype)init;
